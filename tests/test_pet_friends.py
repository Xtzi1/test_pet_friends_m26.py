...
def test_add_new_pet_without_photo(name='Томми the Cat', animal_type='kit', age='3'):
...
def test_add_new_pet_with_invalid_auth_key(name='Жерар', animal_type='Sobaken', age='5', pet_photo='images/cat1.jpg'):
...
def test_unsuccessful_get_auth_key_with_invalid_email(email='s0d@s0od.er', password=valid_password):
...
def test_unsuccessful_get_auth_key_with_invalid_password(email=valid_email, password='qweoi3'):
...
def test_add_new_pet_with_png_photo(name='Барбоскин', animal_type='двортерьер',
...
def test_unsuccessful_add_new_pet_with_empty_values(name='', animal_type='',
...
def test_add_new_pet_with_huge_values(
...
def test_unsuccessful_update_pet_info_with_empty_values(name='', animal_type='', age=''):
...
def test_delete_pet_with_wrong_auth_key():
